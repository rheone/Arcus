...
Check("Parse CIDR notation", () =>
{
    var s = Subnet.Parse("192.168.0.0/24");
    RequireEqual(IPAddress.Parse("192.168.0.0"), s.NetworkPrefixAddress, "NetworkPrefixAddress");
...
Check("Construct from address + routing prefix", () =>
{
...
Check("Construct from two addresses (smallest containing subnet)", () =>
{
...
Check("Touches (adjacent subnets)", () =>
{
...
Check("Enumerate (small /30 = 4 addresses)", () =>
{
...
Check("ContainsAnyPrivateAddresses", () =>
{
...
Check("Deconstruct (address, prefix)", () =>
{
...
Check("Construct IPv6 from address + prefix", () =>
{
...
Check("IPv6 Contains and Overlaps", () =>
{
...
Check("Construct arbitrary range", () =>
{
...
Check("FewestConsecutiveSubnetsFor", () =>
{
...
Check("PrivateIPAddressRangesList", () =>
{
    Require(SubnetUtilities.PrivateIPAddressRangesList.Count > 0, "list not empty");
    Require(
        SubnetUtilities.PrivateIPAddressRangesList.Any(s => s.Contains(IPAddress.Parse("10.1.2.3"))),
        "10.1.2.3 is in private list"
    );
    Require(
        SubnetUtilities.PrivateIPAddressRangesList.Any(s => s.Contains(IPAddress.Parse("192.168.0.1"))),
        "192.168.0.1 is in private list"
    );
});

Check("LargestSubnet / SmallestSubnet", () =>
{
    var subnets = new[] { Subnet.Parse("10.0.0.0/24"), Subnet.Parse("10.0.0.0/16"), Subnet.Parse("10.0.0.0/28") };
...
Check("IsGreaterThanOrEqualTo / IsLessThanOrEqualTo", () =>
{
...
Check("IPv4 min/max address constants", () =>
{
    RequireEqual(IPAddress.Parse("0.0.0.0"), IPAddressUtilities.IPv4MinAddress, "IPv4Min");
    RequireEqual(IPAddress.Parse("255.255.255.255"), IPAddressUtilities.IPv4MaxAddress, "IPv4Max");
});

Check("IsValidNetMask", () =>
{
...
Check("ValidAddressFamilies", () =>
{
    Require(IPAddressUtilities.ValidAddressFamilies.Contains(AddressFamily.InterNetwork), "InterNetwork valid");
    Require(IPAddressUtilities.ValidAddressFamilies.Contains(AddressFamily.InterNetworkV6), "InterNetworkV6 valid");
});

Check("ParseFromHexString (IPv4)", () =>
{
...
Check("NetmaskToCidrRoutePrefix", () =>
{
...
Check("DefaultIPAddressComparer", () =>
{
...
Check("DefaultIIPAddressRangeComparer", () =>
{
...
Check("DefaultAddressFamilyComparer", () =>
{
    ...
    Require(comparer.Compare(AddressFamily.InterNetwork, AddressFamily.InterNetwork) == 0, "IPv4 == IPv4");
});
