...
The main `src/Arcus.Tests/` suite references the library via a *project reference*, which
...
└── SmokeTests/
    ├── SmokeTests.csproj     # multi-target console app; PackageReference to Arcus
