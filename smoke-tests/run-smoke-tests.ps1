...
.DESCRIPTION
    1. Packs the Arcus library into a local NuGet feed (smoke-tests\feed\).
...
.EXAMPLE
    ...
    .\smoke-tests\run-smoke-tests.ps1 -Version 4.1.0-preview
...
$LibProj      = Join-Path $RepoRoot  "src\Arcus\Arcus.csproj"
...
Write-Header "Step 1 — Pack Arcus $Version"
