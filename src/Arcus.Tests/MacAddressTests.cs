...
#pragma warning disable IDE0062 // Make local function static (IDE0062); purposely allowing non-static functions that could be static for .net4.8 compatibility
    ...
    [Obsolete("MacAddress is a candidate for removal in future major version")]
    public class MacAddressTests
    {
        ...
        public void CompareTo_MacAddress_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
        ...
        {
            // Arrange
            var expected = Enumerable.Repeat((byte)0xFF, 6).ToArray();
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void GetHashCode_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
        ...
        public void IsGloballyUnique_Test(bool expected, byte[] bytes)
        {
            // Arrange
            var macAddress = new MacAddress(bytes);
        ...
        public void IsLocallyAdministered_Test(bool expected, byte[] bytes)
        {
            // Arrange
            var macAddress = new MacAddress(bytes);
        ...
        [InlineData(true, new byte[] { 0b1111_1111, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF })]
        public void IsMulticast_Test(bool expected, byte[] bytes)
        {
            // Arrange
            var macAddress = new MacAddress(bytes);
        ...
        [InlineData(false, new byte[] { 0b1111_1111, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF })]
        public void IsUnicast_Test(bool expected, byte[] bytes)
        {
            // Arrange
            var macAddress = new MacAddress(bytes);
        ...
        {
            var byteArrayMax = Enumerable.Repeat((byte)0xff, 6).ToArray();

            var byteArrayMin = Enumerable.Repeat((byte)0x00, 6).ToArray();
        ...
        {
            var bytes = Enumerable.Repeat((byte)0xff, 6).ToArray();
            var macAddress = new MacAddress(bytes);
        ...
        public void IsDefault_Test(bool expeted, MacAddress macAddress)
        {
            // Arrange
            // Act
        ...
        public void IsUnusable_Test(bool expected, MacAddress macAddress)
        {
            // Arrange
        ...
        {
            // Arrange
            var bytes = Enumerable.Repeat((byte)0xAC, byteCount).ToArray();
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void CompareTo_Object_Test(int expected, MacAddress left, object right)
        {
            // Arrange
            // Act
            var result = left.CompareTo(right);
...
#pragma warning restore xUnit1026
        ...
        public void Parse_HappyPath_Test(MacAddress expected, string input)
        {
            // Arrange
...
#pragma warning restore xUnit1026
        ...
        [MemberData(nameof(Parse_Test_SuccessValues))]
        [MemberData(nameof(Parse_Test_FailValues))]
        public void TryParse_Test(MacAddress expected, string input)
        {
            // Arrange
        ...
        public void ParseAny_HappyPath_Test(MacAddress expected, string input)
        {
            // Arrange
...
#pragma warning restore xUnit1026
        ...
        [MemberData(nameof(ParseAny_Test_SuccessValues))]
        [MemberData(nameof(ParseAny_Test_FailValues))]
        public void TryParseAny_Test(MacAddress expected, string input)
        {
            // Arrange
        ...
        public static IEnumerable<object[]> ParseAny_Test_SuccessValues()
        {
            ...
            IEnumerable<object[]> NonStandardFormatTestCases()
            {
                var bytes = new byte[] { 0x00, 0xCD, 0xEF, 0x01, 0x23, 0x45 };
                var expected = new MacAddress(bytes);
                var byteStrings = bytes.Select(b => $"{b:X2}").ToArray();
                ...
                {
                    expected,
                    string.Join("_", string.Join(string.Empty, byteStrings).Select(c => $"{c}")),
                };
            }

            IEnumerable<object[]> StandardFormatTestCases()
            {
                var formatProvider = CultureInfo.InvariantCulture;
                var formats = new[] { "g", "c", "s", "d", "X" };
        ...
        public void IFormattable_Test(string expected, byte[] bytes, string format, IFormatProvider formatProvider)
        {
            // Arrange
            var macAddress = new MacAddress(bytes);
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void Equals_MacAddress_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
        ...
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        [MemberData(nameof(Comparison_MacAddress_Object_Values))]
        public void Equals_Object_Test(int expected, MacAddress left, object right)
        {
            // Arrange
            // Act
            var result = left.Equals(right);
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void Operator_Equal_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void Operator_NotEqual_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
            var result = left != right;
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void Operator_LessThan_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
            var result = left < right;
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void Operator_GreaterThan_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
            var result = left > right;
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void Operator_LessThanOrEqualTo_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
            var result = left <= right;
        ...
        [Theory]
        [MemberData(nameof(Comparison_MacAddress_MacAddress_Values))]
        public void Operator_GreaterThanOrEqual_Test(int expected, MacAddress left, MacAddress right)
        {
            // Arrange
            // Act
            var result = left >= right;
        ...
        public void AllFormantMacAddressRegularExpression_Matches_Test(string input)
        {
            ...
            // Assert
            Assert.True(isMatch);
            var count = Regex.Matches(input, @"[\dA-Fa-f]").Count;
