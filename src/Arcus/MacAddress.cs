...
namespace Arcus
{
            ...
            IEquatable<MacAddress>, IComparable<MacAddress>, IComparable, IFormattable
    {
        ...
        /// </remarks>
        public static readonly Regex AllFormatMacAddressRegularExpression = new Regex(
            AllFormatMacAddressPattern,
        ...
        /// </remarks>
        public static readonly Regex CommonFormatMacAddressRegularExpression = new Regex(
            CommonFormatMacAddressPattern,
            RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.IgnoreCase
        );
        ...
        /// <summary>Gets a value indicating whether checks if the MAC Address is unicast</summary>
        /// <value>returns <see true="true" /> if the MAC Address is unicast</value>
        public bool IsUnicast => (byte)(this._address[0] & 1) == 0;

        /// <summary>Gets a value indicating whether checks if the MAC Address is multicast</summary>
        /// <value>returns <see true="true" /> if the MAC Address is multicast</value>
        public bool IsMulticast => (byte)(this._address[0] & 1) != 0;

        /// <summary>Gets a value indicating whether checks if the MAC Address is globally unique (OUI enforced)</summary>
        ...
        /// <summary>Gets a value indicating whether checks if the MAC Address is locally administered</summary>
        ...
        /// <summary>Gets a value indicating whether checks if the MAC Address is the EUI-48 default</summary>
        ...
        {
            return this._address.Take(3).ToArray();
        }
        ...
        {
            return this._address.Skip(3).Take(3).ToArray();
        }
        ...
        public override bool Equals(object obj)
        {
            return !ReferenceEquals(null, obj)
                && (ReferenceEquals(this, obj) || (obj.GetType() == GetType() && this.Equals((MacAddress)obj)));
        }
        ...
        private static MacAddress ExtractHextetsAndCreateMacAddress(string input)
        {
            ...
            var matchValues = new Regex(
                hexCharactersPattern,
                RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.IgnoreCase
            );
