...
namespace Arcus
{
    ...
    public interface IIPAddressRange : IFormattable, IEnumerable<IPAddress>
    {
        ...
        /// </summary>
        /// <returns><see langword="true"/> if, and only if, the range contains any private addresses</returns>
        bool ContainsAnyPrivateAddresses();

        /// <summary>
        ///     Determines if the range contains all private addresses
        /// </summary>
        /// <returns><see langword="true"/> if, and only if, the range contains all private addresses</returns>
        bool ContainsAllPrivateAddresses();

        /// <summary>
        ///     Determines if the range contains any public addresses
        /// </summary>
        /// <returns><see langword="true"/> if, and only if, the range contains any public addresses</returns>
        bool ContainsAnyPublicAddresses();

        /// <summary>
        ///     Determines if the range contains all public addresses
        /// </summary>
        /// <returns><see langword="true"/> if, and only if, the range contains all public addresses</returns>
